...
<div class="container">
    <h2 style="text-align:center;"><i>Rate Product</i></h2>
    <?php
    ...
    foreach ($itemDetails as $item) {
        $average = $rating->getRatingAverage($item["ProductId"]);
    ?>
        <div class="row">
            <div class="col-sm-2" style="width:150px">
                <img class="product_image" src="../Doc/img//<?php echo $item["ImageUrl"]; ?>" style="width:100px;height:200px;padding-top:10px;">
            </div>
            <div class="col-sm-4">
                <h4 style="margin-top:10px;"><?php echo $item["ProductName"]; ?></h4>
                <div><span class="average"><?php printf('%.1f', $average); ?> <small>/ 5</small></span> <span class="rating-reviews"><a href="show_rating.php?item_id=<?php echo $item["ProductId"]; ?>">Rating & Reviews</a></span></div>
    ...
    <div id="ratingDetails">
        <div class="row">
            ...
            <div class="col-sm-3">
                <button type="button" id="rateProduct" class="btn btn-info <?php
            ...
            <div class="col-sm-7">
                ...
                <div class="review-block">
                    ...
                    foreach ($itemRating as $rating) {
                        $date = date_create($rating['CreatedOn']);
                    ...
                    $userIdToFind = $rating['UserId'];
                        $getUserSql = "SELECT * FROM users WHERE Id ='$userIdToFind'";
                        $res = mysqli_query($conn,$getUserSql);
                        if ($res != null) {
                    ...
                    ?>
                        <div class="row">
                            <div class="col-sm-3">
                                <img src="image/userpic/user5.jpg" class="img-rounded user-pic">
                                <div class="review-block-name">By <a href="#"><?php echo $row['Name']; ?></a></div>
    ...
    <div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="loginmodal-container">
                <h1>You need to logg in to rate this product!</h1><br>
            </div>
        </div>
    </div>
</div>